# 2. Filtrar lista de clientes inadimplentes
# O objetivo é identificar quem são os clientes inadimplentes e enviar
# essa lista de clientes para o setor de cobrança poder fazer a cobrança dos clientes. Queremos então criar uma lista
# com os clientes inadimplentes (apenas o CPF e o valor que eles estão devendo) A inadimplência nessa empresa é
# calculada da seguinte forma: se o cliente tiver devendo há mais de 20 dias, ele é considerado inadimplente. As
# informações vêm no formato (cpf, valor_devido, quantidade de dias)
...
clientes_inadimplentes = [(cpf, valor) for cpf, valor, dias in clientes_devedores if dias > dias_limite]

for cpf, valor in clientes_inadimplentes:
    print('CPF {} está com R${:.2f} de inadimplência'.format(cpf, valor))
