...
lista_vendas_2019 = [(vendas_2019, produto) for produto, vendas_2019, vendas_2020 in vendas_produtos]
...
vendas_2019, produto = lista_vendas_2019[0]

print('{} foi o produto mais vendido em 2019 - R${:.2f}'.format(produto.title(), vendas_2019))
